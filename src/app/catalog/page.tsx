...
export const metadata: Metadata = {
  title: "Notre Carte",
  description:
    "Parcourez notre sélection de gâteaux, tartes et chocolats faits maison.",
};
        ...
        <div className="flex flex-wrap gap-2 mb-8">
          <Link href="/catalog">
            <Badge
              ...
              className={cn(
                "cursor-pointer text-sm py-2 px-4 hover:bg-amber-100",
                !category && "bg-amber-600 hover:bg-amber-700",
              )}
            >
              Tout voir
            </Badge>
          ...
          {categories.map((cat) => (
            <Link key={cat.id} href={`/catalog?category=${cat.slug}`}>
              <Badge
                ...
                className={cn(
                  "cursor-pointer text-sm py-2 px-4 hover:bg-amber-100",
                  category === cat.slug && "bg-amber-600 hover:bg-amber-700",
                )}
              >
                {cat.name}
              </Badge>
