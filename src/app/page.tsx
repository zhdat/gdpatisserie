    ...
    <main className="min-h-screen bg-slate-50">
      ...
      <section className="relative bg-slate-900 text-white py-32 text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4">
          <Badge className="mb-4 bg-amber-500 hover:bg-amber-600">Artisan Pâtissier à
            Marseille</Badge>
          <h1 className="text-5xl md:text-7xl font-bold mb-6 font-serif">
            Le goût de l&apos;authentique
          </h1>
          <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto leading-relaxed">
            Découvrez nos créations faites maison. Commandez en ligne et faites-vous livrer la
            douceur directement chez vous.
          </p>
      ...
      <section className="max-w-7xl mx-auto py-20 px-4">
        <div className="flex justify-between items-end mb-10">
          <div>
            <h2 className="text-3xl font-bold text-slate-900">Les Nouveautés</h2>
            <p className="text-slate-500 mt-2">Nos dernières créations sorties du four.</p>
          </div>
          <Link href="/catalog"
            ...
            <Card key={product.id}
              ...
              <div className="relative h-64 w-full bg-slate-200 overflow-hidden">
                ...
                <div className="absolute top-3 left-3">
                  <Badge
                    className="bg-white/90 text-black hover:bg-white">{product.category.name}</Badge>
                </div>
              </div>
              ...
              <CardHeader>
                <div className="flex justify-between items-center">
                  <CardTitle
                    className="text-xl group-hover:text-amber-700 transition-colors">{product.name}</CardTitle>
        ...
        <div className="mt-10 text-center md:hidden">
          <Link href="/catalog">
            <Button variant="outline" className="w-full">Voir toute la carte</Button>
          </Link>
        </div>
      </section>
      ...
      <section className="bg-white py-20">
        <div className="max-w-5xl mx-auto px-4 text-center">
          ...
          <p className="text-lg text-slate-600 leading-relaxed mb-8">
            Chez GD Pâtisserie, nous ne travaillons qu&apos;avec des produits frais et de saison.
            Pas de stocks industriels, tout est préparé à la commande pour garantir une qualité
            exceptionnelle.
            <br/>
