  ...
  return (
    <form action={action} className="space-y-6">
      ...
      <div className="grid w-full gap-1.5">
        ...
        <Input type="text" name="name" id="name" required placeholder="Ex: Tarte aux Fraises"
      ...
      <div className="grid w-full gap-1.5">
        ...
        <Textarea name="description" id="description" placeholder="Ingrédients..."
      ...
      <div className="flex items-center space-x-2 border p-4 rounded-md bg-slate-50">
        ...
        <div className="grid gap-1.5 leading-none">
          ...
          <p className="text-sm text-muted-foreground">
            Décochez cette case pour marquer le produit comme "Épuisé" sans le supprimer.
          </p>
        </div>
      </div>

      <div className="flex justify-end gap-4">
        <Button type="submit">{initialData ? "Modifier le produit" : "Créer le produit"}</Button>
      </div>
    </form>
  )
}