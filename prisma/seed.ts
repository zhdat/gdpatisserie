    ...
    data: [
      {
        ...
        description:
          "Une pâte sablée croustillante, un crémeux citron acidulé et une meringue italienne légère.",
        price: 24.0,
        imageUrl:
      ...
      },
      {
        name: "Royal Chocolat",
        description:
          "Mousse chocolat noir 70%, biscuit dacquoise noisette et croustillant praliné.",
        price: 28.5,
        imageUrl:
      ...
      },
      {
        ...
        description:
          "Assortiment de nos meilleurs bonbons au chocolat (Ganaches, Pralinés).",
        price: 18.0,
        imageUrl:
